        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <x-nav-dropdown title="Apps" align="right" width="48">
                        ...
                        @endcan
                        @can('view-any', App\Models\Tariff::class)
                        <x-dropdown-link href="{{ route('tariffs.index') }}">
                        Tariffs
                        </x-dropdown-link>
                        @endcan
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link :href="route('dashboard')" :active="request()->routeIs('dashboard')">
                ...
                @endcan
                @can('view-any', App\Models\Faq::class)
                <x-responsive-nav-link href="{{ route('faqs.index') }}">
                Faqs
                </x-responsive-nav-link>
                @endcan
                @can('view-any', App\Models\Job::class)
                ...
                @endcan
                @can('view-any', App\Models\News::class)
                <x-responsive-nav-link href="{{ route('all-news.index') }}">
                All News
                </x-responsive-nav-link>
                @endcan
                @can('view-any', App\Models\Tariff::class)
                <x-responsive-nav-link href="{{ route('tariffs.index') }}">
                Tariffs
                </x-responsive-nav-link>
                @endcan
                @can('view-any', App\Models\User::class)
